...
namespace DL_EF
{
    ...
    public partial class JGuevaraProgramacionNCapasMayoEntities : DbContext
    {
        public JGuevaraProgramacionNCapasMayoEntities()
            : base("name=JGuevaraProgramacionNCapasMayoEntities")
        {
        }
        ...
        public virtual int MateriaAdd(string nombre, Nullable<byte> creditos, Nullable<decimal> costo, Nullable<int> idSemestre, string imagen, Nullable<System.DateTime> fecha)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("MateriaAdd", nombreParameter, creditosParameter, costoParameter, idSemestreParameter, imagenParameter, fechaParameter);
        }
        ...
        public virtual int MateriaUpdate(Nullable<int> idMateria, string nombre, Nullable<byte> creditos, Nullable<decimal> costo, Nullable<int> idSemestre, string imagen, Nullable<System.DateTime> fecha, string turno)
        {
            var idMateriaParameter = idMateria.HasValue ?
                new ObjectParameter("IdMateria", idMateria) :
                new ObjectParameter("IdMateria", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("MateriaUpdate", idMateriaParameter, nombreParameter, creditosParameter, costoParameter, idSemestreParameter, imagenParameter, fechaParameter, turnoParameter);
        }
